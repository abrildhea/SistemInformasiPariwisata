		...
		<div class="kt-portlet">
			<div class="kt-portlet__head kt-portlet__head--lg" style="">
				<div class="kt-portlet__head-label">
					<h3 class="kt-portlet__head-title">Form Tambah Data Kecamatan</h3>
				</div>
			...
			<!--begin::Form-->
			<form role="form" action="?admin=kcm&kec=add" method="post" enctype="multipart/form-data" class="kt-form kt-form--fit">
				<div class="kt-portlet__body">
					<div class="form-group row">
						<label class="col-lg-3 col-form-label">Kecamatan</label>
						<div class="col-lg-9">
							<input class="form-control" name="kecamatan" type="text" id="kecamatan" required>
