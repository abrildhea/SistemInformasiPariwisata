...
<link href="html/assets/css/demo1/skins/aside/dark.css" rel="stylesheet" type="text/css">        <!--end::Layout Skins -->
            ...
            <div class="kt-login__body">
                ...
                <div class="kt-login__form">
                    <div class="kt-login__logo">
                                <center><img src="assets/media/logos/images.png" style="height: 115px;"></center><br>
                        </div>
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="?and=add" enctype="multipart/form-data" method="post" role="form" style="margin-top: -25px;">
                        <div class="form-group">
                            <input required class="form-control" type="text" placeholder="Nama" name="nama" autocomplete="off" value="<?= $nama ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input required class="form-control" type="text" placeholder="Profil" name="profil" autocomplete="off" value="<?= $profil ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="kt-login__actions">
                            ...
                            <button onclick="location.href='./'" class="btn btn-outline-brand btn-pill">Kembali</button>
                        </div>
                    </form>
                    <!--end::Form-->
                </div>
